...
import auimg from "/src/assets/imgs/img8.jpg";
export default function AsFirstsection() {
  return (
    <div className="font-sans">
      <div className="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-yellow">
        <div className="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
          <h2 className="text-black lg:text-5xl text-3xl font-bold lg:!leading-[56px]">
            Our vision is to revolutionize the way You enjoy food
          </h2>
          <p className="text-black font-medium mt-6 text-base leading-relaxed">
            We are passionate food lovers on a mission to bring
            restaurant-quality meals to your doorstep. Combining fresh
            ingredients, skilled chefs, and a love for culinary art, we’ve
            created a food delivery experience that feels like dining out, even
            when you’re at home.
          </p>
          <button
            type="button"
            className="bg-black border-2 border-gray-800 mt-12 transition-all text-white cursor-pointer font-bold text-sm rounded-md px-6 py-2.5"
          >
            Get Started
          </button>
        </div>
      ...
      <div className="grid lg:grid-cols-4 bg-black py-10  md:grid-cols-2 gap-6 px-4 ">
        <AuCard
          description="Choosing us means choosing quality"
          icon={
            <svg
        ...
        />
        <AuCard
          description="Chef-crafted dishes made with the freshest ingredients."
          icon={
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="#007bff"
        ...
        />
        <AuCard
          description="An extensive menu catering to every taste and dietary need."
          icon={
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="#007bff"
        ...
        />
        <AuCard
          description="Timely deliveries to ensure your food arrives hot and fresh."
          icon={
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="#007bff"
